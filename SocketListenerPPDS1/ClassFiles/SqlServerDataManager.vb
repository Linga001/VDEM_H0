...
#Region "Public Methods"
        ...
        Public Function ExecuteQuery(ByVal SQLList As List(Of String)) As Boolean
            ' Function will be used by client to Execute SQL Query over SQL Database
            If m_Connection.State = ConnectionState.Open Then
                m_Connection.Close()
            End If
            ...
            Try
                ...
                For i As Integer = 0 To SQLList.Count - 1
                    m_Command.CommandText = SQLList.Item(i)
                    m_Command.CommandType = CommandType.Text
                    oObject = m_Command.ExecuteNonQuery
                Next
            ...
            Finally
                ...
                If returnValue = 1 Then
                    If m_Command.Transaction IsNot Nothing Then
